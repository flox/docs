...
Flox packages and installation instructions for `rpm` and `deb` based distributions are available from the [Install Flox][install-flox] page.
...
[intro-section]: /imageless-kubernetes/intro
[install-flox]: /install-flox/install

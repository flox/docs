---
title: "Web server with Redis on kind"
...
This environment contains the [`flox/quotes-app-go`](https://hub.flox.dev/flox/quotes-app-go) package, which is a simple web server published to FloxHub.

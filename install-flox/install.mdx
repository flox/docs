...
<Tabs>
  ...
  **Download and install the package that matches your machine's architecture.**
  ...
  1. Download installer for Macs with
      ...
      [Apple Silicon](https://downloads.flox.dev/by-env/stable/osx/flox-X.Y.Z.aarch64-darwin.pkg)
      [Intel processors](https://downloads.flox.dev/by-env/stable/osx/flox-X.Y.Z.x86_64-darwin.pkg)
  ...
  **Download and install the package**
  ...
  1. Download flox.deb for your system architecture:
       ...
       [64-bit Intel/AMD](https://downloads.flox.dev/by-env/stable/deb/flox-X.Y.Z.x86_64-linux.deb)
       [64-bit ARM](https://downloads.flox.dev/by-env/stable/deb/flox-X.Y.Z.aarch64-linux.deb)
  ...
  **Download and install the package**
  ...
  1. Download flox.rpm for your system architecture:
       ...
       [64-bit Intel/AMD](https://downloads.flox.dev/by-env/stable/rpm/flox-X.Y.Z.x86_64-linux.rpm)
       [64-bit ARM](https://downloads.flox.dev/by-env/stable/rpm/flox-X.Y.Z.aarch64-linux.rpm)

...
<Note>
  **Verify your download**
  ...
  You can find the
  [SHA256 checksums](https://downloads.flox.dev/by-env/stable/flox-1.12.1.SHA256SUMS) and
  [SHA512 checksums](https://downloads.flox.dev/by-env/stable/flox-1.12.1.SHA512SUMS) for
  Flox 1.12.1 online.
</Note>
<Tabs>
  <Tab title="MacOS (Pkg)">
  ...
  **Download and install the package that matches your machine's architecture.**
  ...
  1. Download installer for Macs with
      ...
      <CardGroup cols={2}>
        <Card title="Apple Silicon" icon="apple" href="https://downloads.flox.dev/by-env/stable/osx/flox-1.12.1.aarch64-darwin.pkg">
          aarch64-darwin
        </Card>
        <Card title="Intel processors" icon="microchip" href="https://downloads.flox.dev/by-env/stable/osx/flox-1.12.1.x86_64-darwin.pkg">
          x86_64-darwin
        </Card>
      </CardGroup>
  ...
  **Download and install the package**
  ...
  1. Download flox.deb for your system architecture:
       ...
       [64-bit Intel/AMD](https://downloads.flox.dev/by-env/stable/deb/flox-1.12.1.x86_64-linux.deb)
       [64-bit ARM](https://downloads.flox.dev/by-env/stable/deb/flox-1.12.1.aarch64-linux.deb)
  ...
  **Download and install the package**
  ...
  1. Download flox.rpm for your system architecture:
       ...
       [64-bit Intel/AMD](https://downloads.flox.dev/by-env/stable/rpm/flox-1.12.1.x86_64-linux.rpm)
       [64-bit ARM](https://downloads.flox.dev/by-env/stable/rpm/flox-1.12.1.aarch64-linux.rpm)

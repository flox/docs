...
<Tabs>
  ...
  with the best method available on your machine. It supports MacOS, 
  ...
  * On Fedora- and RHEL-family systems, it installs the `.rpm` package
  ...
  <AccordionGroup>
    <Accordion title="What happens if Nix is already installed?">
    ...
    <Accordion title="Which systems does the script refuse to run on?">

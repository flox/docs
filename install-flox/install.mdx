...
<Note>
  **Verify your download**
  ...
  You can find the
  [SHA256 checksums](https://downloads.flox.dev/by-env/stable/flox-1.17.0.SHA256SUMS) and
  [SHA512 checksums](https://downloads.flox.dev/by-env/stable/flox-1.17.0.SHA512SUMS) for
  Flox 1.17.0 online.
</Note>
<Tabs>
  ...
  * On Fedora and RHEL-family systems, it installs the `.rpm` package
  ...
  1. Download installer for Macs with
      ...
      <CardGroup cols={2}>
        <Card title="Apple Silicon" icon="apple" href="https://downloads.flox.dev/by-env/stable/osx/flox-1.17.0.aarch64-darwin.pkg">
          aarch64-darwin
        </Card>
        <Card title="Intel processors" icon="microchip" href="https://downloads.flox.dev/by-env/stable/osx/flox-1.17.0.x86_64-darwin.pkg">
          x86_64-darwin
        </Card>
      </CardGroup>
  ...
  ```
  curl -LO https://downloads.flox.dev/by-env/stable/deb/flox-1.17.0.x86_64-linux.deb
  sudo apt install ./flox-1.17.0.x86_64-linux.deb
  ```

  64-bit ARM:

  ```
  curl -LO https://downloads.flox.dev/by-env/stable/deb/flox-1.17.0.aarch64-linux.deb
  sudo apt install ./flox-1.17.0.aarch64-linux.deb
  ```
  ...
  1. Run the command for your system architecture:
      ...
      ```
      curl -LO https://downloads.flox.dev/by-env/stable/rpm/flox-1.17.0.x86_64-linux.rpm
      sudo rpm -ivh ./flox-1.17.0.x86_64-linux.rpm
      ```

      64-bit ARM:

      ```
      curl -LO https://downloads.flox.dev/by-env/stable/rpm/flox-1.17.0.aarch64-linux.rpm
      sudo rpm -ivh ./flox-1.17.0.aarch64-linux.rpm
      ```
  ...
  * unregister and delete distribution: `wsl --unregister <name>`
  ...
  <Accordion title="Ubuntu">
    ...
    ```
    curl -LO https://downloads.flox.dev/by-env/stable/deb/flox-1.17.0.x86_64-linux.deb
    sudo dpkg -i ./flox-1.17.0.x86_64-linux.deb
    ```
    ...
    ```
    curl -LO https://downloads.flox.dev/by-env/stable/deb/flox-1.17.0.aarch64-linux.deb
    sudo dpkg -i ./flox-1.17.0.aarch64-linux.deb
    ```
  </Accordion>

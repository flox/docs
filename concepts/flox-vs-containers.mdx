...
in agent sandboxes. See our [Comparison FAQ](/concepts/flox-vs-containers-faq/) for more information.
...
description = "curl, yarn 1.22, and Python 3.10 for the demo service"
...
The `description` travels with the environment when you push, pull, or include it,
so nobody has to hunt for a README to learn what the environment is for.
A `Dockerfile` has no equivalent.

...
[builds-concept]: /concepts/builds
[manifest-reference]: /man/manifest.toml#build
[services-concept]: /concepts/services
[publish-concept]: /concepts/publishing
[fhs-docs]: https://en.wikipedia.org/wiki/Filesystem_Hierarchy_Standard
[pkg-groups]: /man/manifest.toml#package-descriptors
[grpc]: https://grpc.io/
[organizations-concept]: /concepts/organizations
[go-example]: /languages/go#build-with-flox

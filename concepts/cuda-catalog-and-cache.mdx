...
If an environment is pre-populated with many dependencies, Flox's resolver may select an older version of PyTorch. If this happens, consider isolating PyTorch in its own [package group](/concepts/package-groups), as shown above.

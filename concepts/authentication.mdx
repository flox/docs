...
[`flox activate`](/man/flox-activate) does not require authentication. If your
...
We spent the last few months making this easy.
...
If you're using Flox with coding agents, we recently published
[flox/flox-skills](https://github.com/flox/flox-skills/), which lets Claude,
Codex, and similar agent tools use Flox in natural language.

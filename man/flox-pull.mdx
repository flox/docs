...
environemnt `<owner>/<name>` on FloxHub. You can make changes locally
and push them back with [`flox-push(1)`](/man/flox-push).
...
[`flox-edit(1)`](/man/flox-edit). See
[`manifest.toml(5)`](/man/manifest.toml) for more on multi-system
environments.
...
Pull the specified generation instead of the live generation. Must be
used with `--copy`.
...
[`flox-push(1)`](/man/flox-push) [`flox-edit(1)`](/man/flox-edit)

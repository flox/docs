...
[`flox-generations-history(1)`](/man/flox-generations-history) or
...
[`flox-generations-history(1)`](/man/flox-generations-history) can be
...
[`flox-generations-history(1)`](/man/flox-generations-history)
[`flox-generations-list(1)`](/man/flox-generations-list)

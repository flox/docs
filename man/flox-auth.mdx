...
stdin). FloxHub must be reachable to validate personal access tokens and
service account tokens. The validated token is stored without opening a
browser or prompting for input. Use this in CI, containers, and other
scripted setups.

...
![FloxHub device confirmation](/images/device-confirmation.png)
...
![Successful push to FloxHub](/images/auth-successfull.png)
...
![FloxHub environment view](/images/floxhub-environment.png)
...
[create_guide]: /tutorials/creating-environments
[sharing]: /tutorials/sharing-environments
[init]: /man/flox-init
[search]: /man/flox-search
[show]: /man/flox-show
[catalog]: /concepts/packages-and-catalog
[install]: /man/flox-install
[activate]: /man/flox-activate
[edit]: /man/flox-edit
[push]: /man/flox-push
[list]: /man/flox-list
[manifest]: /man/manifest.toml
[multi-arch]: /tutorials/multi-arch-environments
...
[install-section]: /man/manifest.toml#install
[activation-tutorial]: /tutorials/customizing-environments
[ci]: /tutorials/ci-cd
[composition]: /tutorials/composition
[homebrew]: /tutorials/migrations/homebrew
[build-publish]: /tutorials/build-and-publish

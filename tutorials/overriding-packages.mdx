...
```nix title=".flox/pkgs/hello/default.nix"
{ hello, fetchurl }:
...
[publishing-concept]: /concepts/publishing
[extensions-example]: /concepts/nix-expression-builds#example-extensions-of-an-existing-package
[patches-example]: /concepts/nix-expression-builds#example-patches-to-an-existing-package
[vendor-example]: /concepts/nix-expression-builds#example-vendor-an-existing-package
[build-and-publish]: /tutorials/build-and-publish

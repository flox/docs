...
```bash
git clone ..example-project && flox activate
```

[flox_init]: /man/flox-init
[discourse]: https://discourse.flox.dev/
[manifest_concept]: /concepts/environments#manifesttoml
...
[flox_push]: /man/flox-push
[flox_pull]: /man/flox-pull
[flox_activate]: /man/flox-activate
[floxhub_concept]: /concepts/floxhub
...
-  [Designing multiple architecture environments][multi_arch_guide]

[multi_arch_guide]: /tutorials/multi-arch-environments
[environment_concept]: /concepts/environments
[layering_guide]: /tutorials/layering-multiple-environments
[customizing_guide]: /tutorials/customizing-environments
[flox_containerize]: /man/flox-containerize

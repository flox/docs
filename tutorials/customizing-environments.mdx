...
```bash
mkdir mycli && cd mycli && flox init && flox install rustc cargo libiconv
```
...
-  [Multiple architecture environments][multi-arch-guide]

[environment_concept]: /concepts/environments
[flox_activate]: /man/flox-activate
[multi-arch-guide]: /tutorials/multi-arch-environments
[rust_guide]: /languages/rust
[flox_init]: /man/flox-init
[activation_concept]: /concepts/activation

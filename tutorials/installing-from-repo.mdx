...
description: "Install Flox by adding its official APT or YUM/DNF repository to your Debian- or Red Hat-based Linux distribution so updates flow through your package manager."
---
...
<Note>
  ...
  see the [Debian SecureApt wiki](https://wiki.debian.org/SecureApt)
